...
load("~/Workspace/06_mdd.liver/paper/clustering-total/mdd.liver.filter1/mdd.filter1_meta.data.RData")
...
load("~/Workspace/06_mdd.liver/paper/clustering-epi/epi.filter1_meta.data.RData")
...
pdf("Extended Fig6a.number_strength-netVisual.pdf", width = 8, height = 5)
par(mfrow = c(1, 2))
