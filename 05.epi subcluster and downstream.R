...
save(subset_cells, file = "~/Workspace/06_mdd.liver/paper/clustering-epi/epi.filter1.RData")

meta.data <- epi.filter1@meta.data
save(meta.data,file="~/Workspace/06_mdd.liver/paper/clustering-epi/epi.filter1_meta.data.RData")
