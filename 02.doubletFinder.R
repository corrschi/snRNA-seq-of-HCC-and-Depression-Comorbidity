...
# path set
data_dir_base <- "~/Workspace/06_mdd.liver/singlesample"
out_dir <- "~/Workspace/06_mdd.liver/paper/doublet-new"
setwd(out_dir)
...
merged_seurat$group <- ifelse(grepl("^Stress", merged_seurat$sample), "HCC+CRS", "HCC")

save(merged_seurat, file = file.path(out_dir, "mdd_liver_doublet_removed_merged.RData"))
