...
mkdir -p ~/Workspace/rawdata_softlink

# Define raw data and link paths
RAW= ~/Workspace/rawData/mdd.liver
LINK= ~/Workspace/rawdata_softlink
...
~/software/bin/cellranger6 count \
--id=__SAMPLE__ \
--transcriptome=~/reference_data/refdata-gex-mm10-2020-A \
--fastqs=~/Workspace/rawdata_softlink \
--sample=__SAMPLE__ \
